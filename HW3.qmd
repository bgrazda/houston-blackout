...
invisible(ifelse(nrow(blackout_highways) < nrow(blackout_mask_3083), (print(paste0("TRUE, new sf object is shorter than old sf object by ", (nrow(blackout_mask_3083) - nrow(blackout_highways)), " rows"))), (print("FALSE, new sf object is NOT shorter than old sf object, check crop methods")))) 
